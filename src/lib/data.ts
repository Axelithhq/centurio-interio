...
export const transformations = [
  {
    id: 1,
    title: "Penthouse Great Room Sanctuary",
    category: "Luxury Residential",
    beforeText: "Raw Structural Shell (Pre-Construction)",
    afterText: "Finished Italian Travertine & Brass Lounge",
    beforeImage: "/transformations/room1_before.jpg",
    afterImage: "/transformations/room1_after.jpg",
    location: "Civil Lines, Jaipur",
    area: "4,200 sq. ft.",
    duration: "14 Weeks",
    highlights: ["Italian Travertine Fireplace", "Suspended Brass Chandelier", "Acoustic Fluted Oak Walls"],
  },
  {
    id: 2,
    title: "Monolith Executive Headquarters",
    category: "Commercial Architecture",
    beforeText: "Raw Structural Shell (Pre-Construction)",
    afterText: "Minimalist Open-Plan Executive Suite",
    beforeImage: "/transformations/room2_before.jpg",
    afterImage: "/transformations/room2_after.jpg",
    location: "C-Scheme, Jaipur",
    area: "6,800 sq. ft.",
    duration: "18 Weeks",
    highlights: ["Frameless Glass Partitions", "Acoustic Timber Ceiling Slats", "Smart Ambient Light Coves"],
  },
  {
    id: 3,
    title: "Solarium Culinary & Dining Studio",
    category: "Bespoke Residential",
    beforeText: "Raw Structural Shell (Pre-Construction)",
    afterText: "Open German Joinery & Waterfall Island",
    beforeImage: "/transformations/room3_before.jpg",
    afterImage: "/transformations/room3_after.jpg",
    location: "Vaishali Nagar, Jaipur",
    area: "1,850 sq. ft.",
    duration: "8 Weeks",
    highlights: ["Quartzite Waterfall Island", "German Soft-Close Systems", "Integrated Miele Appliances"],
  },
  {
    id: 4,
    title: "Verdant Courtyard Heritage Revival",
    category: "Heritage Renovation",
    beforeText: "Raw Structural Shell (Pre-Construction)",
    afterText: "Modern Glass Curtain Courtyard Villa",
    beforeImage: "/transformations/room4_before.jpg",
    afterImage: "/transformations/room4_after.jpg",
    location: "Udaipur, Rajasthan",
    area: "5,400 sq. ft.",
    duration: "22 Weeks",
    highlights: ["Restored Rajasthani Arches", "Double-Height Thermal Glass", "Structural Steel Framework"],
  },
];
...
export const teamMembers = [
  ...
  },
  {
    ...
    bio: "Award-winning designer known for creating elegant, functional spaces with a modern aesthetic.",
  },
  {
    name: "Rohit Verma",
