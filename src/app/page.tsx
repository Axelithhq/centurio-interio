  ...
  return (
    <SmoothScrollWrapper>
      <div className="relative bg-luxury-dark text-charcoal selection:bg-gold selection:text-white min-h-screen">
        ...
        {/* All content sections sit above Background3D and held canvas */}
        <div className="relative z-[1]">

        {/* ========================================================================= */}
        {/* 2. ABOUT & PHILOSOPHY (Split Layout + Parallax + Interactive Swatches) */}
        {/* ========================================================================= */}
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                {/* Interactive Material Swatch Picker */}
                <motion.div variants={fadeUp} className="pt-6 border-t border-gray-200">
                  <span className="text-xs font-mono uppercase text-gray-500 block mb-3">
                    Curated Material Palette Lab:
                  </span>
              ...
              >
                ...
                <div className="absolute -bottom-6 -left-6 bg-charcoal text-white p-6 rounded-sm shadow-2xl border border-gold/30 hidden md:block max-w-xs">
                  ...
                  <span className="text-xs font-mono uppercase tracking-widest text-gray-300 block">
                    Years of Architectural Mastery &amp; Heritage
                  </span>
                </div>
              </motion.div>
            </div>
        ...
        {/* ========================================================================= */}
        {/* 3. SERVICES SECTION (Interactive Cards with Hover 3D & Specs) */}
        {/* ========================================================================= */}
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <span className="text-gold text-xs font-mono tracking-widest uppercase block mb-2">
                02 // Our Services Suite
              </span>
              <h2 className="font-serif-luxury text-3xl sm:text-5xl">
                Bespoke Architectural <span className="gold-text">&amp; Interior Offerings.</span>
              </h2>
              <p className="text-gray-600 text-sm md:text-base font-light mt-4">
                From luxury residential estates to high-end corporate flagships, we deliver uncompromised spatial design.
              </p>
            </div>
              ...
              {services.map((service, i) => (
                <ScrollReveal3D key={service.id} delay={i * 100} direction="up">
                  <TiltCard tiltAmount={8} depth={15}>
                    <motion.div
                      variants={fadeUp}
                      className="group relative bg-ivory rounded-sm overflow-hidden border border-gray-200/60 hover:border-gold/50 hover-3d-lift shimmer-line"
                >
                  {/* Service Image */}
                  <div className="relative h-60 w-full overflow-hidden">
                    ...
                    <span className="absolute top-4 left-4 bg-gold text-white text-[10px] font-mono uppercase tracking-widest px-3 py-1 rounded-sm">
                      {service.tag}
                    </span>
                  </div>
                  ...
                  {/* Card Content */}
                  <div className="p-6">
                    <h3 className="font-serif-luxury text-2xl text-charcoal mb-2 group-hover:text-gold transition-colors">
                      {service.title}
                    </h3>
                    <p className="text-gray-600 text-xs leading-relaxed font-light mb-4">
                      {service.description}
                    </p>
                    ...
                    <a
                      href="#contact"
                      className="inline-flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-gold mt-6 hover:translate-x-1 transition-transform"
                    >
        ...
        {/* ========================================================================= */}
        {/* 4. FEATURED PROJECTS (Horizontal Scroll Gallery with 3D Tilt) */}
        {/* ========================================================================= */}
        ...
        {/* ========================================================================= */}
        {/* 5. STICKY 360° ROOM MODEL INSPECTOR (Scroll Rotation + Hotspots) */}
        {/* ========================================================================= */}
        ...
        {/* ========================================================================= */}
        {/* 7. DESIGN PROCESS / TIMELINE (Golden Glow Line Draw-In) */}
        {/* ========================================================================= */}
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-20">
              ...
              <h2 className="font-serif-luxury text-3xl sm:text-5xl text-white">
                Our Architectural <span className="gold-text">Design Process</span>
              </h2>
              <p className="text-gray-400 text-sm font-light mt-4">
                A structured journey from conceptual discovery to turnkey presentation.
              </p>
            </div>
        ...
        <section id="testimonials" className="relative py-24 bg-luxury-dark text-white overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="font-serif-luxury text-3xl sm:text-5xl">
                What Our <span className="gold-text">Patrons Express</span>
              </h2>
            </div>
        ...
        {/* ========================================================================= */}
        {/* 10. GALLERY GRID (FLIP Layout Animation) */}
        {/* ========================================================================= */}
        ...
        <section id="faq" className="relative py-24 bg-luxury-sand text-charcoal overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 md:px-8 relative z-10">
            <div className="text-center mb-16">
              ...
              <h2 className="font-serif-luxury text-3xl sm:text-5xl">
                Frequently Asked <span className="gold-text">Queries</span>
              </h2>
            </div>
              ...
              {faqs.map((faq, i) => (
                <ScrollReveal3D key={i} delay={i * 80} direction="left">
                  ...
                  <button
                    ...
                    className="w-full text-left p-6 flex items-center justify-between font-serif-luxury text-xl font-semibold"
                  >
                    <span>{faq.q}</span>
                    <span className="text-gold text-2xl">{faqOpen === i ? "−" : "+"}</span>
                  </button>
                  {faqOpen === i && (
                    <div className="px-6 pb-6 text-gray-600 text-xs md:text-sm font-light leading-relaxed border-t border-gray-100 pt-4">
                      {faq.a}
                    </div>
                  )}
                </div>
        ...
        {/* ========================================================================= */}
        {/* 12. CONTACT & CONSULTATION CTA SECTION */}
        {/* ========================================================================= */}
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <MouseParallax3D intensity={6} perspective={1200}>
                <div>
                <span className="text-gold text-xs font-mono tracking-widest uppercase block mb-2">
                  06 // Private Engagement
                </span>
                <h2 className="font-serif-luxury text-3xl sm:text-5xl mb-6">
                  Commission Your <span className="gold-text">Sanctuary.</span>
                </h2>
                <p className="text-gray-400 text-sm font-light mb-8 leading-relaxed">
                  Request a private consultation with our principal architects. We accept a limited number of commissions annually to preserve exacting detail.
                </p>
                ...
                {formSubmitted ? (
                  <div className="p-8 glass-dark rounded-sm border border-gold text-center">
                    ...
                    <p className="text-gray-300 text-xs font-mono">
                      Our studio concierge will reach out within 24 hours to schedule your private design session.
                    </p>
                  </div>
                ) : (
                  <form onSubmit={handleFormSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <input
                        ...
                        className="w-full px-4 py-3.5 bg-white/5 border border-white/10 rounded-sm text-xs text-white placeholder-gray-500 focus:outline-none focus:border-gold transition-colors"
                      />
                      <input
                        type="email"
                        required
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      />
                      <select
                        className="w-full px-4 py-3.5 bg-white/5 border border-white/10 rounded-sm text-xs text-gray-300 focus:outline-none focus:border-gold transition-colors"
                      >
                    ...
                    <textarea
                      rows={4}
                      placeholder="Project Details (Location, Estimated Sq. Ft, Vision)..."
                      className="w-full px-4 py-3.5 bg-white/5 border border-white/10 rounded-sm text-xs text-white placeholder-gray-500 focus:outline-none focus:border-gold transition-colors resize-none"
                    />
                    <button
                      type="submit"
                      className="w-full gold-bg text-white py-4 rounded-sm text-xs font-mono tracking-widest uppercase hover:shadow-2xl hover:shadow-gold/30 transition-all duration-300"
                    >
              ...
              {/* Direct Concierge Info & Map Column */}
              <div className="flex flex-col justify-between space-y-8">
                <div className="glass-dark p-8 rounded-sm border border-white/10 space-y-6">
                  ...
                  <div>
                    ...
                    <a href={`tel:${businessInfo.phone}`} className="text-white text-lg hover:text-gold transition-colors">
                      {businessInfo.phone}
                    </a>
                  </div>
                  ...
                  <div className="pt-2">
                    <a
                      ...
                      className="inline-flex items-center gap-3 bg-emerald-700/80 hover:bg-emerald-600 text-white px-6 py-3 rounded-sm text-xs font-mono tracking-widest uppercase transition-all"
                    >
